---
layout: post
title: "Beginner's Guide to Securing Cloud Workloads"
date: 2025-05-08 0:05:00 -0400
categories: [Portfolio]
tags: [cloud-security, madcap-flare, technical-writing, cloud-computing, documentation, gdpr, data-privacy, entry-level, portfolio-project, information-security]
---

## Context

Cloud security is a foundational concern for any organization deploying applications and workloads in cloud environments. Companies need documentation that simplifies compliance requirements, provides actionable guidance, and equips junior developers with the knowledge to build securely by default. I created this guide to serve as a reusable internal resource that could onboard new developers or accompany security reviews during early-stage development.
...
I wrote and structured a five-section guide covering the following critical areas:
...
- Learned how to **set up a Windows environment on Mac** to run MadCap Flare using VMware Fusion
...
- Tools like **MadCap Flare require setup across OS boundaries**, which built my confidence in configuring complex environments
...
- Share the PDF and screenshots of the Flare project on my portfolio site and LinkedIn
- Expand this documentation into an interactive HTML5 help site when I acquire a full MadCap license
